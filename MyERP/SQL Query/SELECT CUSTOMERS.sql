...
FROM            Addresses
LEFT JOIN  Customers ON Addresses.addressID = Customers.addressID 
INNER JOIN  Persons ON Addresses.addressID = Persons.addressID AND Customers.personID = Persons.personID